...
if __name__ == "__main__":
    翻译资源文件(r"C:\Users\FengMang\Desktop\Translator Minecraft\zbgt-0.16.2.jar",
        ...
        "http://127.0.0.1:25564/v1/embeddings", "", "text-embedding-nomic-embed-text-v1.5-embedding", llm_contexts=True,)
    #
    #导出数据集("Alpaca")
    #
    #导入参考词("http://127.0.0.1:25564/v1/embeddings", "", "text-embedding-nomic-embed-text-v1.5-embedding", emb_max_token=2048, emb_max_workers=8)
