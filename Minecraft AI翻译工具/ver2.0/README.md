...
- 更改 存储的格式从 .npy 改为 .npz，Float32 改为 Int8 + Float16缩放（块大小=128） 格式（平均精度损失 1.5547%） [源代码](https://github.com/lingxingmiao/Tools/blob/main/uo%C9%A5%CA%87%CA%8E%D4%80%E6%A8%A1%E5%9D%97.py)
