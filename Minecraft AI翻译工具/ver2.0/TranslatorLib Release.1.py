...
if __name__ == "__main__":
    ...
    TranslatorLang.add_argument("--index-max-workers", type=int, default=128, help="索引最大并发数")
    ...
    TranslatorPack.add_argument("--index-max-workers", type=int, default=128, help="索引最大并发数")
    ...
    if 参数.mode == "TranslatorLang":
        翻译语言文件(
            ...
            llm_p=参数.llm_p,
            llm_k=参数.llm_k,
            index_max_workers=参数.index_max_workers,
            index_k=参数.index_k
        )
